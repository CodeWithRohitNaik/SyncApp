...
{
    /// <inheritdoc />
    public partial class AllowMultipleWorkOrdersPerApu : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HMC = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FAC = table.Column<string>(type: "nvarchar(max)", nullable: true),
